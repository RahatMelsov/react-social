...
const Dialogs = (props) => {
	let usersElements = props.userData.map(u => <DialogsItem name={u.name} key={u.id} id={u.id} />);
	let dialogsElements = props.dialogsData.map(d => < Messages message={d.message} key={d.id} />);
